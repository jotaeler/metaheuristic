...
from SelectorEstacionario import EstacionarioSelection
from practica2.CruceBeasley import CruceBeasley
...
class Stationary(object):
    ...
    def runStationaryEvolverHUX(self):
        """
        ...
        crossover = Uniform.UniformCrossover(2, 0.7)
        repairer = Repair(self.matrix, self.sectors, self.subsectors, self.costs)

        selector = EstacionarioSelection(mutator, crossover, repairer, 2)
